...
if(isset($_POST['form1'])) {
	...
	if($valid == 1) {
		...
		$statement = $pdo->prepare("INSERT INTO tbl_termos (titulo, detalhes) VALUES (?,?)");
		$statement->execute(array($_POST['titulo'],$_POST['detalhes']));
			
		$success_message = 'Termos adcionado com Sucesso!';
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="termos.php" class="btn btn-primary btn-sm">Visualizar todas</a>
	</div>
</section>
