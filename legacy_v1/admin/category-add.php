...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['category_name'])) {
        $valid = 0;
        $error_message .= "O nome da categoria não pode ficar vazio<br>";
    } else {
    	...
    	{
    		$valid = 0;
        	$error_message .= "O nome da categoria já existe<br>";
    	}
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'A categoria foi adicionada com sucesso.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Adcionar categoria</h1>
	</div>
	<div class="content-header-right">
		<a href="category.php" class="btn btn-primary btn-sm">Visualizar todas</a>
	</div>
</section>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" name="category_name" placeholder="Exemplo: dicas de saúde">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Categoria Slug </label>
							<div class="col-sm-4">
								<input type="text" class="form-control" name="category_slug" placeholder="Exemplo: dicas-de-saude">
							</div>
						</div>
