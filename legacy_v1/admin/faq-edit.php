...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="faq.php" class="btn btn-primary btn-sm">Visualizar Todos</a>
	</div>
</section>
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<textarea class="form-control" name="faq_content" id="1"><?php echo $faq_content; ?></textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Selecione a Categoaria FAQ <span>*</span></label>
							<div class="col-sm-4">
