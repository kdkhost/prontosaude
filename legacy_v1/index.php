...
<section class="service-v1">
	<div class="container">
		...
		<div class="row">
			<?php
			$statement = $pdo->prepare("SELECT * FROM tbl_service ORDER BY rand() LIMIT 3");
			$statement->execute();
			$result = $statement->fetchAll(PDO::FETCH_ASSOC);							
			foreach ($result as $row) {
				?>
				<div class="col-sm-6 col-md-4 col-lg-4">
					<div class="item border border-info">
						...
						<div class="text">
							<div class="inner">
								<h3><a href="../servicos.php"><?php echo $row['name']; ?></a></h3>
								<p><?php echo substr($row['short_description'],0,145); ?></p>
								<p class="button">
									...
									<div class="row">										
										<div class="col-md-7">
											<div class="department-content">
												...
												<p class="button">
													<a href="<?php echo BASE_URL; ?>department/<?php echo $row['dep_slug']; ?>">Detalhes</a>
												</p>											
											</div>
										</div>
										<div class="col-md-5">
...
<section class="pricing-v1" id="fidelidade">
	<div class="container">
		...
		<div class="row">
			...
			<?php
			$statement = $pdo->prepare("SELECT * FROM tbl_pricing_plan ORDER BY pricing_plan_id ASC LIMIT 3");
			$statement->execute();
			$result = $statement->fetchAll(PDO::FETCH_ASSOC);
			foreach ($result as $row) {
				?>
				<div class="col-md-4">
					...
					<div class="pricing-item">
						...
						<div class="offer">
							<ul>
								<?php
								$statement1 = $pdo->prepare("SELECT * FROM tbl_pricing_item WHERE pricing_plan_id=? LIMIT 3");
						...
						<div class="button">
							<a href="../fidelidade.php"><?php echo $row['pricing_plan_button_text']; ?></a>
						</div>
						<?php endif; ?>
					</div>
				</div>
...
<!-- Testimonial Start -->
<section class="testimonial-v1" style="background-image:url(https://biotecnology.mx/wp-content/uploads/2020/07/TEC-1024x650.jpg);">
	<div class="overlay"></div>
	<div class="container">
		<div class="row">
			<div class="col-md-12">
