...
if(isset($_POST['form_contact']))
{
    ...
    {
        $valid = 0;
        $error_message .= 'Por favor, insira seu nome.<br>';
    }

    if(empty($_POST['visitor_phone']))
    {
        $valid = 0;
        $error_message .= 'Por favor, digite seu número de telefone.<br>';
    }
    ...
    {
        $valid = 0;
        $error_message .= 'Por favor, indique o seu endereço de e-mail.<br>';
    }
    else
    {
        ...
        {
            $valid = 0;
            $error_message .= 'Por favor insira um endereço de e-mail válido.<br>';
        }
    }
    ...
    {
        $valid = 0;
        $error_message .= 'Por favor, insira seu comentário.<br>';
    }
...
?>
				...
				<form action="<?php echo BASE_URL; ?>page/<?php echo $_REQUEST['slug']; ?>" class="form-horizontal cform-1" method="post">
					<div class="form-group">
                        <div class="col-sm-12">
                            <input type="text" class="form-control" placeholder="Nome" name="visitor_name">
                        </div>
                    </div>
					<div class="form-group">
                        <div class="col-sm-12">
                            <input type="email" class="form-control" placeholder="Email" name="visitor_email">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12">
                            <input type="text" class="form-control" placeholder="Telefone" name="visitor_phone">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12">
                            <textarea name="visitor_comment" class="form-control" cols="30" rows="11" placeholder="Mensagem"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
	                    <div class="col-sm-12">
	                        <input type="submit" value="Enviar Mensagem" class="btn btn-success" name="form_contact">
	                    </div>
	                </div>
				</form>
			</div>
		...
		<div class="row">
			<div class="col-md-12">			
				...
				foreach ($result as $row) {
					...
					?>
					<?php
					    $categoria = $pdo->prepare("SELECT * FROM tbl_faq WHERE faq_category_id=?");
						$categoria->execute(array($row['faq_category_id']));
						$res = $categoria->fetchAll(PDO::FETCH_ASSOC);
					?>
					<h1>
					    <?php
					        if($res[0]["faq_category_id"] != null){
					            echo $row['faq_category_name'];
					        }
					    ?>
							...
							<div class="panel panel-default">
								<div class="panel-heading" role="tab" id="heading1">
									<h4 class="panel-title">
										...
										href="#collapse<?php echo $j; ?>" aria-expanded="false" aria-controls="collapse<?php echo $j; ?>">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<ul class="gallery-menu">
					<li class="filter" data-filter="all" data-role="button">Todos</li>
					<?php
							...
							<div class="inner">
								...
								<div class="icons">
									<div class="icons-inner">
										<a class="gallery-photo" href="<?php echo BASE_URL; ?>assets/uploads/<?php echo $row['photo_name']; ?>">
					...
					foreach ($result as $row) {
						...
						<div class="col-md-4 mix <?php echo $temp_slug; ?> all" data-my-order="<?php echo $i; ?>">
							<div class="inner viframe">
								<video width="380" height="auto" class="parado" controls preload="auto">
				...
				<div class="blog-grid">
					<div class="row">
						<div class="col-md-12">
							...
							<?php if(!$total): ?>
							<p style="color:red;">Desculpe! Nenhuma notícia foi encontrada.</p>
							<?php else: ?>
...
/* ===================== Pagination Code Starts ================== */
		...
		{   
			...
			if ($page > 1) 
				$pagination.= "<a href=\"$targetpage?slug=$s1&page=$prev\">&#171; anterior</a>";
			else
			...
			if ($page < $counter - 1) 
				$pagination.= "<a href=\"$targetpage?slug=$s1&page=$next\">próximo &#187;</a>";
			else
							...
							foreach ($result as $row) {
								...
								<div class="post-item">
									<div class="image-holder">
										<img class="img-responsive" src="<?php echo BASE_URL; ?>assets/uploads/<?php echo $row['photo']; ?>" 
									...
									<div class="text">
										...
										<ul class="status">
											...
											Categoria: 
											<a href="<?php echo BASE_URL; ?>category/<?php echo $row['category_slug']; ?>">
											    <?php echo $row['category_name']; ?></a></li>
											<li><i class="fa fa-calendar"></i>Data: <?php echo $row['news_date']; ?></li>
										</ul>
										<p>
											<?php echo substr($row['news_content'],0,200).' ...'; ?>
										</p>
										<p class="button">
											<a href="<?php echo BASE_URL; ?>news/<?php echo $row['news_slug']; ?>">Saiba Mais</a>
										</p>
									</div>
								</div>
								<?php
						...
						<div class="col-md-3 item">
							<div class="inner">
								...
								<div class="text">
									...
									<p class="button">
										<a href="<?php echo BASE_URL; ?>doctor/<?php echo $row['slug']; ?>">Ver Perfil Completo</a>
									</p>
								</div>
							</div>
						</div>
