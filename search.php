		...
		<div class="row">
			<div class="col-md-12">
				<div class="banner-text">
					<h1>Procurar por: <?php echo htmlspecialchars($_REQUEST['search_string']); ?></h1>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="blog-grid">
					<div class="row">
						<div class="col-md-12">
							...
							<?php if(!$total): ?>
							<p style="color:red;">Desculpe! Nenhuma notícia foi encontrada nesta categoria.</p>
							<?php else: ?>
...
/* ===================== Pagination Code Starts ================== */
		...
		{   
			...
			if ($page > 1) 
				$pagination.= "<a href=\"$targetpage?search_string=$s1&page=$prev\">&#171; anterior</a>";
			else
			...
			if ($page < $counter - 1) 
				$pagination.= "<a href=\"$targetpage?search_string=$s1&page=$next\">próximo &#187;</a>";
			else
							...
							foreach ($result as $row) {
								...
								<div class="post-item">
									...
									<div class="text">
										...
										<ul class="status">
											<li><i class="fa fa-tag"></i>Categoria: <a href="<?php echo BASE_URL; ?>category/<?php echo $row['category_slug']; ?>"><?php echo $row['category_name']; ?></a></li>
